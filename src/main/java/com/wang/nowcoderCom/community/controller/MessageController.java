...
import com.wang.nowcoderCom.community.service.MessageService;
...
//        System.out.println(user.getId() + " " + page.getOffset() + " " + page.getOffset());
//        System.out.println(conversationList);
    ...
    private User getLetterTarget(String conversationId) {
        ...
        int id0 = Integer.valueOf(ids[0]), id1 = Integer.valueOf(ids[1]);
